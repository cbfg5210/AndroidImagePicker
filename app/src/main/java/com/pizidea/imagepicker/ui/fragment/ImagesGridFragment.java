...
import com.pizidea.imagepicker.util.Util;
    ...
    class ImageGridAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(itemViewType == ITEM_TYPE_CAMERA){
                ...
                GlideImagePresenter.loadFileImage(holder.ivPic, getItem(position).path, imageGridSize);
            }
    ...
    class ImageSetAdapter extends BaseAdapter {
        ...
        class ViewHolder{
            ...
            void bindData(ImageSet data) {
                ...
                GlideImagePresenter.loadFileImage(cover, data.cover.path, imageGridSize);
            }
        }
    }
